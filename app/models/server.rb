class Server < ApplicationRecord
  TALOS_AMD64_IMAGE_URL = "https://github.com/siderolabs/talos/releases/download/v1.4.5/metal-amd64.tar.gz".freeze
  TALOS_ARM64_IMAGE_URL = "https://github.com/siderolabs/talos/releases/download/v1.4.5/metal-arm64.tar.gz".freeze
